...
const TOKENS = {
  ...
  // 文字：肤色（主）/ 金色（次）/ 发色（三）
  "--dsw-alias-label-primary": "3B89C4",
  "--dsw-alias-label-secondary": "E2C05A",
  "--dsw-alias-label-tertiary": "7CC8E8",
  "--dsw-alias-label-caption": "7CC8E8",
  "--dsw-alias-label-dimmed": "rgba(124, 200, 232, 0.55)",
  ...
  "--dsw-alias-button-primary-fill": "7CC8E8",
  "--dsw-alias-button-primary-hover": "3B89C4",
  "--dsw-alias-button-primary-dimmed": "rgba(124, 200, 232, 0.18)",
  "--dsw-alias-button-contrast-fill": "3B89C4",
