...
- 文件路径：`data/plugins/EIGHTfs__dsh-theme-mediascape.yml`

## YAML 内容（复制即用）

```yaml
url: https://github.com/EIGHTfs/dsh-theme-mediascape
name: EIGHTfs/dsh-theme-mediascape
category: theme
description:
...
2. 在 fork 里新增 `data/plugins/EIGHTfs__dsh-theme-mediascape.yml`（内容如上）
